...
HargassnerTelnet.prototype.connect = function (options) {
  var me = this
...
HargassnerTelnet.prototype.parse = function (arr) {
  var Heizung = {}
  Heizung.Puffer = {
  ...
  Heizung.Allgemein = {
    ...
    Standby: ((parseInt(arr[206], 16) & 0x0001) > 0),
    FuellstandOK: ((parseInt(arr[206], 16) & 0x0002) > 0)
  }
  ...
  Heizung.Boiler1 = {
    Ist: arr[42],
    Soll: arr[43],
    Pumpe: ((parseInt(arr[208], 16) & 0x0002) > 0)
  }

  Heizung.Boiler2 = {
    Ist: arr[50],
    Soll: arr[51],
    Pumpe: ((parseInt(arr[208], 16) & 0x0004) > 0)
  }
  ...
  Heizung.Heizkreis1 = {
    ...
    Pumpe: ((parseInt(arr[206], 16) & 0x0080) > 0),
    Mischer: {
      Auf: ((parseInt(arr[206], 16) & 0x0100) > 0),
      Zu: ((parseInt(arr[206], 16) & 0x0200) > 0)
    }
  }
  Heizung.Heizkreis2 = {
    VorlaufSoll: arr[39],
    ...
    Pumpe: ((parseInt(arr[206], 16) & 0x0400) > 0),
    Mischer: {
      Auf: ((parseInt(arr[206], 16) & 0x0800) > 0),
      Zu: ((parseInt(arr[206], 16) & 0x1000) > 0)
    }
  }
  Heizung.Heizkreis3 = {
    VorlaufSoll: arr[46],
    ...
    Pumpe: ((parseInt(arr[209], 16) & 0x0001) > 0),
    Mischer: {
      Auf: ((parseInt(arr[209], 16) & 0x0002) > 0),
      Zu: ((parseInt(arr[209], 16) & 0x0004) > 0)
    }
  }
  Heizung.Heizkreis4 = {
    VorlaufSoll: arr[47],
    VorlaufIst: arr[45],
    Pumpe: ((parseInt(arr[209], 16) & 0x0008) > 0),
    Mischer: {
      Auf: ((parseInt(arr[209], 16) & 0x0010) > 0),
      Zu: ((parseInt(arr[209], 16) & 0x0020) > 0)
    }
  }
